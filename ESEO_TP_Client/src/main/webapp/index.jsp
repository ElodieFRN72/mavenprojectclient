...
<body style="height:1500px">
	...
	<div class="container">
		<p class="text-justify">Cette plateforme permet de consulter un ensemble de données sur les villes françaises. <br>
			 ...
			 <div class="col-sm-6 justify-content-end">
					...
					<div class="card text-center shadow p-3 mb-5 bg-white rounded" style="width: 18rem;">
			 			 <div class="card-body">
				    		...
				    		<p class="card-text"> Désormais vous pouvez calculer la distance entre deux villes !</p>
