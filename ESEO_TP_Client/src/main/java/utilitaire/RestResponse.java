...
//		//Type villeFranceListType=TypeToken.getParameterized(ArrayList.class, VilleFrance.class).getType();
//		//System.out.println(villeFranceListType);
//		ArrayList<VilleFrance> villes = gson.fromJson(result.toString(), villeFranceListType);
